...
Module Funciones
    ...
    Public idseguimiento As Integer = 0 'Variable para empezar la edicion
    ...
    Public Sub colorearpanel(ByVal formulario As Panel, ByVal panelwhite As Panel)
        ...
        Next
    End Sub
    Public Sub busquedas(ByVal dg As DataGridView, ByVal folio As TextBox, ByVal empresa As TextBox, ByVal cot As TextBox, ByVal pendientes As ComboBox, ByVal noc As TextBox, ByVal user As Integer)
        Try
            dg.Rows.Clear()
